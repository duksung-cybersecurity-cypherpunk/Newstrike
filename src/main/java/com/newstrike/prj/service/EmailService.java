...
import com.newstrike.prj.util.RedisUtil;
...
public class EmailService {
    ...
    private static final String senderEmail = "dawoon0620@gmail.com";
    ...
    public void sendHtmlEmailWithNickname(String to, String subject, String htmlBody) {
        ...
        try {
            ...
            helper.setText(htmlBody, true);  // HTML 형식으로 보냄
